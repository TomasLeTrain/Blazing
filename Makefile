...
EXCLUDE_COLD_LIBRARIES:= $(FWDIR)/float_units.a
...
TEMPLATE_FILES+=$(INCDIR)/$(LIBNAME)/controllers/**/*

TEMPLATE_FILES+=$(INCDIR)/$(LIBNAME)/drivetrains/**/*
TEMPLATE_FILES+=$(INCDIR)/$(LIBNAME)/motions/**/*
TEMPLATE_FILES+=$(INCDIR)/$(LIBNAME)/trackers/**/*
